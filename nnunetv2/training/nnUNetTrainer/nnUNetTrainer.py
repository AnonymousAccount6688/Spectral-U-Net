...
class nnUNetTrainer(object):
    ...
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, unpack_dataset: bool = True,
        ...
        self.dataset_name = self.plans_manager.dataset_name
        ...
        # else:
        #     self.output_folder_base = '/afs/crc.nd.edu/user/y/ypeng4/data/trained_models/Dataset201_BrainTumour/BrainTrainer__nnUNetPlans__2d/unknown_my_unet_FusedMBConv_16/unknown_nnunetv2.training.network.model.waveunet.brain_unet.UNet'
        #     # self.output_folder_base = join(self.output_folder_base,
    ...
    def initialize_wandb(self, name, project,
    ...
    def configure_optimizers(self):
        ...
        lr_scheduler = PolyLRScheduler(optimizer, self.initial_lr,  self.initial_lr, self.num_epochs)
