...
def maybe_load_checkpoint(nnunet_trainer: nnUNetTrainer, continue_training: bool, validation_only: bool,
    ...
    if continue_training:
        ...
        if not isfile(expected_checkpoint_file):
            ...
            # if 'Liver' in nnunet_trainer.dataset_name:
            #     expected_checkpoint_file = "/scratch365/ypeng4/data/result/Dataset203_Liver/" \
            #                                "LiverTrainer__nnUNetPlans__2d/unknown_my_unet_FusedMBConv_16/" \
    ...
    if expected_checkpoint_file is not None:
        ...
        print(f"================= Cannot load {expected_checkpoint_file}")
...
def run_ddp(rank, dataset_name_or_id, configuration, fold, tr, p, use_compressed, disable_checkpointing, c, val,
    ...
    if not val:
        nnunet_trainer.run_training(dataset_id=dataset_name_or_id)
