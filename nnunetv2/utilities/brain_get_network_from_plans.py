...
def get_network_from_plans(plans_manager: PlansManager,
    ...
    if True: # configuration_manager.configuration["nnUNetPlans_2d"]:  #  nnUNet_UNet
        # from nnunetv2.training.network.model.waveunet.brain_wave_unet import WaveUNet
        # # from nnunetv2.training.network.model.unet.unet_1 import UNet
        #
        # model = WaveUNet(in_ch=num_input_channels,
        #                  num_classes=label_manager.num_segmentation_heads,
        #                  block="BasicBlock")

        from nnunetv2.training.network.model.waveunet.brain_unet import UNet

        model = UNet(in_ch=num_input_channels,
                     num_classes=label_manager.num_segmentation_heads,
                     block="BasicBlock")
        ...
        elif configuration_manager.configuration["my_net_class"] == "pvt_5":
            from nnunetv2.training.network.model.dim2.pvt.pvt_5 import PVTNetwork_5
            model = PVTNetwork_5(n_classes=2, deep_supervision=False)
        elif configuration_manager.configuration["my_net_class"] == "unet_plus":
            from nnunetv2.training.network.model.dim2.unetpp import UNetPlusPlus
            model = UNetPlusPlus(in_ch=3, num_classes=2, deep_supervision=False)
        else:
            raise NotImplementedError("not implemented")
