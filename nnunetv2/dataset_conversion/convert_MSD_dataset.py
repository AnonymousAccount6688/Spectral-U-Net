...
if __name__ == '__main__':
    # convert_msd_dataset('/scratch365/ypeng4/data/raw_data/Dataset001_BrainTumour')

    # convert_msd_dataset('/scratch365/ypeng4/data/raw_data/Dataset001_BrainTumour',
    #                     overwrite_target_id=201)

    convert_msd_dataset('/scratch365/ypeng4/data/raw_data/Task03_Liver',
                        overwrite_target_id=203)
